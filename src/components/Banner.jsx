  ...
  return (
    <div className="relative min-h-[85vh] flex flex-col justify-center items-center overflow-hidden px-4 sm:px-6 lg:px-8 py-20 bg-black">
      ...
      >
        ...
        <motion.h1 
          variants={itemVariants}
          className="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-white mb-6 leading-[1.1] max-w-4xl"
        >
        ...
        <motion.p 
          variants={itemVariants}
          className="text-zinc-400 text-lg sm:text-xl max-w-2xl mb-12 leading-relaxed font-normal"
        >
        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              type="submit"
              className="w-full md:w-12 h-12 rounded-[14px] bg-gradient-to-r from-[#0088FF] to-[#0055FF] hover:from-[#339FFF] hover:to-[#2277FF] flex items-center justify-center text-white transition-all shadow-[0_4px_14px_rgba(0,136,255,0.3)] hover:shadow-[0_6px_20px_rgba(0,136,255,0.45)] cursor-pointer shrink-0"
              aria-label="Search"
            >
              <svg
                className="w-5 h-5"
